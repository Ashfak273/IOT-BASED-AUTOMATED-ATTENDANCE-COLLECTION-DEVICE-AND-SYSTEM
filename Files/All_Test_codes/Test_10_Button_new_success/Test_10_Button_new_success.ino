...
// const char* ssid     = "SLT_5G";
// const char* password = "issath1998";

const char* ssid     = "AK27";
...
const int button1Pin = 32; // GPIO pin for Button 1 for Enroll
const int button2Pin = 35; // GPIO pin for Button 2 for verify
...
void setup() 
{
  pinMode(button1Pin, INPUT); // Set Button 1 pin as input with pull-up resistor
  pinMode(button2Pin, INPUT); // Set Button 2 pin as input with pull-up resistor
  ...
  display.print("Enroll : press E/e\n\nVerify : press V/v");
  display.display();
}
...
void loop() 
{
  // Read the state of Button 1 & Button 2
  int button1State = digitalRead(button1Pin);
  int button2State = digitalRead(button2Pin);

  if (button1State == HIGH && button2State == LOW) // Add your code for 'E' or 'e' action here
  {
    enroll();
  }
  else if (button2State == HIGH && button1State == LOW) // Add your code for 'V' or 'v' action here
  {
    verify();
  }
  else
